...
class TestLiveCapitalProvider:
    ...
    def test_init_with_kite_client(self):
        """Test initialization with Kite client."""
        mock_kite = MagicMock()
...
class TestCreateCapitalProvider:
    ...
    def test_create_live_mode_provider_with_kite(self):
        """Test creating provider for LIVE mode with Kite client."""
        mock_kite = MagicMock()
